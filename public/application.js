...
var gameHistorySuccess = function gameHistorySuccess(data) {
  store.user = data.user;
  console.log(data);
...
var gameHistoryFailure = function gameHistoryFailure(data) {
  $('#message').css('display', 'block');
...
var boardClickSuccess = function boardClickSuccess(data) {
  store.user = data.user;
  console.log(data.user.game);
};
var boardClickFailure = function boardClickFailure(data) {
  store.user = data.user;
...
module.exports = {
  ...
  boardClickSuccess: boardClickSuccess,
  boardClickFailure: boardClickFailure
};
...
var onBoardClick = function onBoardClick(event) {
  ...
  api.boardClick(data).then(ui.boardClickSuccess).catch(ui.boardClickFailure);
};

var onGameHistory = function onGameHistory(event) {
  event.preventDefault();
  // const data = getFormFields(event.target)
  console.log('events game-history working');
  api.gameHistory().then(ui.gameHistorySuccess).catch(ui.gameHistoryFailure);
};

var onGameStatus = function onGameStatus(event) {
  event.preventDefault();
  var data = getFormFields(event.target);
  console.log('events game-status is working');
  api.gameStatus(data).then(ui.gameStatusSuccess).catch(ui.gameStatusFailure);
};
...
// Gameboard api
var boardClick = function boardClick(data) {
...
// Game history
var gameHistory = function gameHistory(data) {
...
var leaderBoard = function leaderBoard(data) {
